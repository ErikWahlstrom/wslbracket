...
export class RoundOf32 {
  ...
  constructor(seededSurfers: SeedingBracket, surfersFromLosers: LosersBracket) {
    ...
    this.heats = [
      ...
      new TwoManHeat(4, qualifiedSurfers[9], qualifiedSurfers[31-9]),

      new TwoManHeat(5, qualifiedSurfers[1], qualifiedSurfers[31]),
      ...
      new TwoManHeat(11, qualifiedSurfers[7], qualifiedSurfers[31-7]),
      new TwoManHeat(12, qualifiedSurfers[11], qualifiedSurfers[31-11]),

      new TwoManHeat(13, qualifiedSurfers[3], qualifiedSurfers[28]),
      new TwoManHeat(14, qualifiedSurfers[12], qualifiedSurfers[31-12]),
      new TwoManHeat(15, qualifiedSurfers[4], qualifiedSurfers[31-4]),
      new TwoManHeat(16, qualifiedSurfers[8], qualifiedSurfers[31-8])
    ];
  }
